...
public class GA_FREE_Demo01 : MonoBehaviour
{
	...
	IEnumerator MoveInPrimaryButtons()
	{
		...
		// MoveIn all primary buttons
		m_TopLeft_A.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);
		m_BottomLeft_A.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);
		m_RightBar_A.PlayInAnims(GUIAnimSystemFREE.eGUIMove.Self);
	...
	{
		// Disable m_TopLeft_A, m_RightBar_A, m_RightBar_C, m_BottomLeft_A for a few seconds
		StartCoroutine(DisableButtonForSeconds(m_TopLeft_A.gameObject, 3f));
		StartCoroutine(DisableButtonForSeconds(m_RightBar_A.gameObject, 3f));
		StartCoroutine(DisableButtonForSeconds(m_RightBar_C.gameObject, 3f));
		StartCoroutine(DisableButtonForSeconds(m_BottomLeft_A.gameObject, 3f));
	...
	void ToggleTopLeft()
	{
		...
		if(m_TopLeft_IsOn==true)
		{
			...
			m_TopLeft_B.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleBottomLeft()
	{
		...
		if(m_BottomLeft_IsOn==true)
		{
			...
			m_BottomLeft_B.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
	...
	void ToggleRightBar()
	{
		...
		if(m_RightBar_IsOn==true)
		{
			...
			m_RightBar_A.PlayOutAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
			// m_RightBar_B moves in
			m_RightBar_B.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
		}
		else
		{
			// m_RightBar_A moves in
			m_RightBar_A.PlayInAnims(GUIAnimSystemFREE.eGUIMove.SelfAndChildren);
